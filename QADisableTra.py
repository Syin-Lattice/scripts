...
def parser():
    ...
    if args.zk :
       ...
       print ("Please select zk true , if you want to disable zk. Otherwise, zk won't be disbaled") 

    if args.rds:
       DisableRDS()
    else: 
       print ("Please select rds true , if you want to disable rds. Otherwise, rds won't be disbaled") 
